...
[source,sh]
----
kubectl label namespace elastic-system eck.k8s.acceldata.io/operator-name=elastic-operator
kubectl label namespace team-a eck.k8s.acceldata.io/tenant=team-a
kubectl label namespace team-b eck.k8s.acceldata.io/tenant=team-b
----
...
spec:
  ...
  - ports:
    ...
    - namespaceSelector:
        matchLabels:
          eck.k8s.acceldata.io/tenant: team-a
      podSelector:
        matchLabels:
          common.k8s.acceldata.io/type: elasticsearch
  - ports:
  ...
  - from:
    - namespaceSelector:
        matchLabels:
          eck.k8s.acceldata.io/operator-name: elastic-operator
      podSelector:
        matchLabels:
          app.kubernetes.io/name: elastic-operator
    - namespaceSelector:
    ...
    - ports:
      ...
      to:
        - namespaceSelector:
          ...
          podSelector:
            matchLabels:
              common.k8s.acceldata.io/type: agent
    - ports:
        - port: {kb_port}
          protocol: TCP
      to:
