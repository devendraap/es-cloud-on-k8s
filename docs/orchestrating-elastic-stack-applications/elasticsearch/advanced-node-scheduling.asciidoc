          ...
          podAntiAffinity:
            ...
            - weight: 100
              podAffinityTerm:
                labelSelector:
                  matchLabels:
                    elasticsearch.k8s.acceldata.io/cluster-name: quickstart
...
. On the Elasticsearch resources set the `eck.k8s.acceldata.io/downward-node-labels` annotations with the list of the Kubernetes node labels that should be copied as Pod annotations.
...
metadata:
  annotations:
    eck.k8s.acceldata.io/downward-node-labels: "topology.kubernetes.io/zone"
  name: quickstart
spec:
  version: {version}
  nodeSets:
        ...
        topologySpreadConstraints:
          - maxSkew: 1
            ...
            labelSelector:
              matchLabels:
                elasticsearch.k8s.acceldata.io/cluster-name: quickstart
                elasticsearch.k8s.acceldata.io/statefulset-name: quickstart-es-default
----
