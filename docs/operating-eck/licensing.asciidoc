...
metadata:
  ...
  labels:
    license.k8s.acceldata.io/type: enterprise_trial
  annotations:
...
metadata:
  labels:
    license.k8s.acceldata.io/scope: operator <1>
  name: eck-license
type: Opaque
data:
...
kubectl label secret eck-license "license.k8s.acceldata.io/scope"=operator -n elastic-system
----
