...
import (
	...
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/common/daemonset"
	...
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/common/statefulset"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/common/tracing"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/utils/k8s"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/utils/pointer"
)
