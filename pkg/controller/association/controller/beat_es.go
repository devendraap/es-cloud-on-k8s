...
const (
	...
	// Beat name.
	BeatAssociationLabelName = "beatassociation.k8s.acceldata.io/name"
	// BeatAssociationLabelNamespace marks resources created for an association originating from Beat with the
	// Beat namespace.
	BeatAssociationLabelNamespace = "beatassociation.k8s.acceldata.io/namespace"
	...
	BeatAssociationLabelType = "beatassociation.k8s.acceldata.io/type"
)
