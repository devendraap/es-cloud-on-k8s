...
import (
	...
	commondriver "github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/common/driver"
	...
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/certificates"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/cleanup"
	esclient "github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/client"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/configmap"
	...
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/license"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/observer"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/reconcile"
	"github.com/devendra/es-cloud-on-k8s/v2/pkg/controller/elasticsearch/remotecluster"
...
func (d *defaultDriver) maybeSetServiceAccountsOrchestrationHint(
	...
	// as compatible with service accounts. This is mostly to unblock situation described in https://github.com/devendra/es-cloud-on-k8s/issues/5684
	if !esReachable {
