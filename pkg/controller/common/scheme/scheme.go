...
import (
	...
	easv1alpha1 "github.com/devendra/es-cloud-on-k8s/v2/pkg/apis/autoscaling/v1alpha1"
	...
	commonv1beta1 "github.com/devendra/es-cloud-on-k8s/v2/pkg/apis/common/v1beta1"
