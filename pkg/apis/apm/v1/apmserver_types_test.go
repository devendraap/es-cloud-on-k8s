...
func TestApmEsAssociation_AssociationConfAnnotationName(t *testing.T) {
	...
	require.Equal(t, "association.k8s.acceldata.io/es-conf", aea.AssociationConfAnnotationName())
}

func TestApmKibanaAssociation_AssociationConfAnnotationName(t *testing.T) {
	aka := ApmKibanaAssociation{}
	require.Equal(t, "association.k8s.acceldata.io/kb-conf", aka.AssociationConfAnnotationName())
}
