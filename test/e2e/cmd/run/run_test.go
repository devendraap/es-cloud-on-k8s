...
func Test_goLangTestTimestampParser(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "happy path",
			args: args{
				line: `{"Time":"2020-08-19T07:55:30.02987855Z","Action":"output","Package":"github.com/devendra/es-cloud-on-k8s/v2/test/e2e/beat","Test":"TestBeatKibanaRefWithTLSDisabled/All_expected_Pods_should_eventually_be_ready","Output":"=== RUN   TestBeatKibanaRefWithTLSDisabled/All_expected_Pods_should_eventually_be_ready\n"}`,
			},
